...
// Function for sliders on featured page 

const wrapper = document.querySelector(".wrapper");
const carousel = document.querySelector(".carousel");
const firstCardWidth = carousel.querySelector(".productcard").offsetWidth;
...
// login page Function for alert on sucessfull or un sucessfull login
